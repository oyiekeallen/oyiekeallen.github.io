	...
	********************************************************/
	if($("#page-content").length > 0){
		$('#page-content').fullpage({
			...
			slideSelector: false,
			menu: '#top-menu',
			anchors: ['home', 'skills', 'portofolio','testimonials' ],
...
***************************************************************************/
	...
	***********************************************/
	if($("#section9").width() > 0){
		...
		var unavailableDates = ["9-5-2018", "20-5-2018", "15-7-2018"];
...
const token = "879f5588-2220-4732-8060-f7e29ce43c49";
const $formContact = document.querySelector("#contactForm");
const receiver="oyiekeallen@gmail.com";
const sender="oyiekea@gmail.com";
